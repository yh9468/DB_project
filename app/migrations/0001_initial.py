# Generated by Django 2.2.5 on 2019-12-08 04:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Plan',
            fields=[
                ('Plan_ID', models.PositiveIntegerField(primary_key=True, serialize=False, verbose_name=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Month_limit', models.FloatField(verbose_name=10)),
                ('Day_limit', models.FloatField(verbose_name=10)),
            ],
            options={
                'db_table': 'INF_table',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('plan_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='app.Plan')),
                ('Total_limit', models.FloatField(verbose_name=10)),
            ],
            options={
                'db_table': 'NOR_table',
            },
