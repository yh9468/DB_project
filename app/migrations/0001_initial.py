# Generated by Django 2.2.5 on 2019-12-10 04:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message_usage', models.PositiveIntegerField(default=0, verbose_name='message_usage')),
                ('call_usage', models.PositiveIntegerField(default=0, verbose_name='call_usage')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Jan', models.FloatField(verbose_name='Jan')),
                ('Feb', models.FloatField(verbose_name='Feb')),
                ('Mar', models.FloatField(verbose_name='Mar')),
                ('Apr', models.FloatField(verbose_name='Apr')),
                ('May', models.FloatField(verbose_name='May')),
                ('Jun', models.FloatField(verbose_name='Jun')),
                ('Jul', models.FloatField(verbose_name='Jul')),
                ('Aug', models.FloatField(verbose_name='Aug')),
                ('Sep', models.FloatField(verbose_name='Sep')),
                ('Oct', models.FloatField(verbose_name='Oct')),
                ('Nov', models.FloatField(verbose_name='Nov')),
                ('Dec', models.FloatField(verbose_name='Dec')),
                ('Use_max', models.FloatField(verbose_name='Use_max')),
                ('phonenum', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': '사용량',
                'db_table': 'Use_table',
